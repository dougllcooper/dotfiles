...
" Shortcutting split navigation (move between panes), saving a keypress:
	map <C-h> <C-w>h
	map <C-j> <C-w>j
	map <C-k> <C-w>k
	map <C-l> <C-w>l
...
" press i to enter insert, ii to exit or jk,kj to exit
...
"
" setup vim-lsp and rnix-lsp for nix
"
