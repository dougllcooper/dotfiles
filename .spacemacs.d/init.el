...
This function should only modify configuration layer settings."
  (setq-default
   ...
   ;; List of additional paths where to look for configuration l-medium-medium
   ...
   '(
     ...
     ;; common-lisp
     common-lisp
     ;; Try common-lisp-sly github.com/AntonyBlakey/spacemacs-common-lisp-sly
     ;;common-lisp-sly
...
before packages are loaded."
  ...
  (setq projectile-project-search-path '("~/code/clojure" "~/quicklisp/local-projects"))
